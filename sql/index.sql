...
CREATE TABLE IF NOT EXISTS conversation (
  id SERIAL PRIMARY KEY,
  conversation_id INT GENERATED BY DEFAULT AS IDENTITY,        -- thread/chat id (you control this in app)
  user_ids INT[] NOT NULL,             -- both user IDs in one array
...
ON conversation (conversation_id, created_at);
